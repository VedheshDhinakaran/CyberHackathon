        ...
        with open(file_path, 'rb') as f:
            ...
            for ts, buf in pcap:
                try:
                    ...
                    if len(tcp.data) > 0:
                        # Very basic carving for HTTP responses
                        if tcp.data.startswith(b'HTTP/'):
                            try:
                                ...
                                if http.body and len(http.body) > 100:
                                    ...
                                    elif 'application/x-msdownload' in ct: ext = ".exe"
                                    elif 'application/json' in ct: ext = ".json"
